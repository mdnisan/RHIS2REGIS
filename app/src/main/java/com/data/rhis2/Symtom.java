...
/**
 * Created by Nisan on 11/26/2015.
 */
public class Symtom extends Activity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        AlertDialog.Builder adb = new AlertDialog.Builder(Symtom.this);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            setContentView(R.layout.symtom);
            C = new Connection(this);
            g = Global.getInstance();
            StartTime = g.CurrentTime24();
            TableName = "symtom";
            TableName1 = "classfication";
            TableName2 = "treatment";
           ...
           /* final ListView list1 = (ListView) findViewById(R.id.lstData1);
            ...
            Connection.MessageBox(Symtom.this, e.getMessage());
            return;
        }
    }
    ...
    private void DataSearch() {
        try {
            ...
            while (!cur.isAfterLast()) {
                ...
                dataAdapter = new SimpleAdapter(Symtom.this, dataList, R.layout.symtomrow, new String[]{"click"},
                        new int[]{R.id.chkB1});
    ...
    private void DataSearch1() {
        try {
            ...
            while (!cur.isAfterLast()) {
                ...
                dataAdapter1 = new SimpleAdapter(Symtom.this, dataList1, R.layout.treatmentrow, new String[]{"click"},
                        new int[]{R.id.chkB1});
