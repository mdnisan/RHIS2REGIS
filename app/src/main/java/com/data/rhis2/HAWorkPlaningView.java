...
/**
 * Created by Nisan on 7/20/2016.
 */
public class HAWorkPlaningView extends Activity {
    Calendar calendar;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        AlertDialog.Builder adb = new AlertDialog.Builder(HAWorkPlaningView.this);
        switch (item.getItemId()) {
            case R.id.menuClose:
                ...
                return true;
            case R.id.menuview:
               Intent intentforview = new Intent(getApplicationContext(), HAWorkPlaningViewAHINotAproved.class);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            setContentView(R.layout.haworkplaningview);
            ...
            lblHS10.setText("স্বাস্থ্য সহকারীর  মাসিক অগ্রিম কর্মসূচী অনুমোদন");
            ...
            spnfpaCode.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                    ...
                    if (val.length() >= 0) {
                        txtFpiWarea.setText(ProvArea("2", Global.Left(spnfpaCode.getSelectedItem().toString(), 6)).replace("null", ""));
                        buttonStatus();
            ...
            cmdSync.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    ...
                    //*******************************************************************************
                    boolean netwoekAvailable = false;
                    if (Connection.haveNetworkConnection(HAWorkPlaningView.this)) {
                        netwoekAvailable = true;
                        //  UploadFWA();
                        final ProgressDialog progDailog = ProgressDialog.show(
                                HAWorkPlaningView.this, "", "অপেক্ষা করুন ...", true);
                        new Thread() {
                            public void run() {
                        ...
                        Connection.MessageBox(HAWorkPlaningView.this, "Internet connection is not available.");
                        // return true;
                    }
                    ...
                    adb.setPositiveButton("হ্যাঁ", new AlertDialog.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            if (C.Existence("Select status from " + TableName + "  Where  month = '" + Global.Right(spnFPIPMonth.getSelectedItem().toString(), 4) + "-" + Global.Left(spnFPIPMonth.getSelectedItem().toString(), 2) + "' AND  providerId  = '" + Global.Left(spnfpaCode.getSelectedItem().toString(), 6) + "'")) {
                                ...
                                C.Save(SQL);
                                Connection.MessageBox(HAWorkPlaningView.this, "অনুমোদিত সম্পন্ন হয়েছে।");
                                ...
                                Connection.MessageBox(HAWorkPlaningView.this, "তথ্য পাওয়া যায় না.");
                            }
                        }
                    });
                    adb.show();
                    ...
                    adb.setPositiveButton("হ্যাঁ", new AlertDialog.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            if (C.Existence(SQ)) {
                                ...
                                SQL += "  Where month='" + Global.Right(spnFPIPMonth.getSelectedItem().toString(), 4) + "-" + Global.Left(spnFPIPMonth.getSelectedItem().toString(), 2) + "' AND  providerId  = '" + Global.Left(spnfpaCode.getSelectedItem().toString(),6) + "'";
                                C.Save(SQL);
                                Connection.MessageBox(HAWorkPlaningView.this, "অননুমোদিত সম্পন্ন হয়েছে।");
    ...
    private void DownloadStatus()
    {
        if (!C.Existence("Select * FROM workPlanDetail WHERE providerId= '" + Global.Left(spnfpaCode.getSelectedItem().toString(), 6) + "' AND substr( workPlanDate, 1, 7 )='" + Global.Right(spnFPIPMonth.getSelectedItem().toString(), 4) + "-" + Global.Left(spnFPIPMonth.getSelectedItem().toString(), 2) + "'")) {
            ...
            cmdDownload.setText("");
            cmdDownload.setText("স্বাস্থ্য সহকারীর  কর্মসূচীটি Download  করতে  এখানে Click করুন ।");
    ...
    private void DisplayNotApprovedItem() {
        ...
        popupView.setContentView(R.layout.hapopup);
    ...
    private void DataSearch(String month, String ProvCode) {
        try {
            ...
            while (!cur.isAfterLast()) {
                ...
                dataAdapter = new SimpleAdapter(HAWorkPlaningView.this, dataList, R.layout.fpaworkplanrowview, new String[]{"edit"},
                        new int[]{R.id.cmdB1});
    ...
    public class DataListAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (o.get("Dstatus").equalsIgnoreCase("2")) {
                ...
                status.setText("" +
                        "HA অগ্রিম কর্মসূচী পরিবর্তন  করতে হবে");
