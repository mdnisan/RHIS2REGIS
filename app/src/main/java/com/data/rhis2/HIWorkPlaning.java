 ...
 */
public class HIWorkPlaning extends Activity {
    Calendar calendar;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        AlertDialog.Builder adb = new AlertDialog.Builder(HIWorkPlaning.this);
        switch (item.getItemId()) {
            ...
            case R.id.menuview:
                ...
                Intent intentforview = new Intent(getApplicationContext(), HIWorkPlaningView.class);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            setContentView(R.layout.hiworkplaining);
            ...
            lblHS10.setText(" স্বাস্থ্য পরিদর্শকের মাসিক অগ্রিম কর্মসূচী");
            ...
            Connection.MessageBox(HIWorkPlaning.this, e.getMessage());
            return;
        }
    }
    ...
    private void DataSearch(String month) {
        try {
            ...
            for (int i = 1; i <= VDay; i++) {
                ...
                dataAdapter = new SimpleAdapter(HIWorkPlaning.this, dataList, R.layout.fpaworkplanrow, new String[]{"edit", "delete"},
    ...
    private void DisplayHIWorkPlaining() {
        final Dialog popupView = new Dialog(HIWorkPlaning.this);
        popupView.setTitle("HI ওয়ার্কপ্ল্যান");

        popupView.requestWindowFeature(Window.FEATURE_NO_TITLE);
        popupView.setContentView(R.layout.hiworkplainingpopup);
        ...
        chkIPCVisit.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if (chkIPCVisit.isChecked()) {
                    ...
                    /*SpnUnion.setAdapter(C.getArrayAdapter(" select distinct substr('0' ||ifnull(p.unionid,'99'), -2, 2)||'-'||u.unionname from Unions u left outer join ProviderArea p on u.zillaid=p.zillaid and  u.upazilaid=p.upazilaid  and  u.unionid=p.unionid"));
                    ...
                    SpnUnion.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        ...
                        public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                            ...
                            if (SpnUnion.getSelectedItemPosition() >0) {
                                ...
                                SpnWord.setAdapter(C.getArrayAdapter("select '-' ward from ProviderArea Union select distinct ward from ProviderArea where zillaid='" + g.getDistrict() + "' and upazilaid='" + g.getUpazila() + "' and unionid='" + Global.Left(SpnUnion.getSelectedItem().toString(), 2) + "'"));
                            }
                ...
                if (cur.getString(cur.getColumnIndex("P1")).equals("1")) {
                    ...
                    if (chkIPCVisit.isChecked()) {
                        ...
                        while (!cur1.isAfterLast()) {
                            ...
                            //SpnUnion.setAdapter(C.getArrayAdapterMultiline("select distinct substr('0' ||p.unionid, -2, 2)||'-'||u.unionname from Unions u left outer join ProviderArea p on u.zillaid=p.zillaid and  u.upazilaid=p.upazilaid and p.unionid='" + cur1.getString(cur1.getColumnIndex("ipcUN")) + "'"));
                           // SpnWord.setAdapter(C.getArrayAdapter("select distinct substr('0' ||ward, -2, 2) from ProviderArea where zillaid='"+ g.getDistrict() +"' and upazilaid='"+ g.getUpazila() +"' and unionid='"+cur1.getString(cur1.getColumnIndex("ipcUN"))+"' and ward='"+cur1.getString(cur1.getColumnIndex("ipcWord"))+"'"));
...
*/
        ...
        cmdSave.setOnClickListener(new View.OnClickListener() {
            public void onClick(View arg0) {
                String SQL = "";
                if (!C.Existence("Select workPlanId from " + TableName + "  Where providerId = '" + g.getProvCode() + "' AND month = '" + Global.Left(g.getAreaDate(), 7) + "'")) //workAreaId='" + g.getAreaUnitValue() + "' AND
                {
                ...
                if (!C.Existence(SQ)) {
                    if (chkIPCVisit.isChecked() == true) {
                        if (SpnMouza.getSelectedItemPosition() == 0) {
                            Connection.MessageBox(HIWorkPlaning.this, "মৌজা /গ্রাম সিলেক্ট করুন।");
                            ...
                            Connection.MessageBox(HIWorkPlaning.this, "বাড়ি পরিদর্শন সংখ্যা  কত লিখুন।");
                            // dtpDeathDT.requestFocus();
                            return;
                        } else if (txtBarivisit2.getText().length() == 0) {
                            Connection.MessageBox(HIWorkPlaning.this, "বাড়ি পরিদর্শন সংখ্যা  কত থেকে লিখুন।");
                            // dtpDeathDT.requestFocus();
                            return;
                        }else {
                            ItemValue.add("1");
                    ...
                    if (chkEPIVisit.isChecked() == true) {
                        ...
                        if (Provider.length()==0) {
                            Connection.MessageBox(HIWorkPlaning.this, "স্বাস্থ্য সহকারীর নাম সিলেক্ট করুন।");
                            // dtpDeathDT.requestFocus();
                            return;
                        }

                        else if (EpiSubBlock.length()==0) {
                            Connection.MessageBox(HIWorkPlaning.this, "ই পি আই সাব-ব্লক সিলেক্ট করুন।");
                            // dtpDeathDT.requestFocus();
                            return;
                        }

                        else if (SessionDate.length()==0) {
                            Connection.MessageBox(HIWorkPlaning.this, "সেশন তারিখ সিলেক্ট করুন।");
                            // dtpDeathDT.requestFocus();
                            return;
                        }
                    ...
                    if (chkHDay.isChecked() == true) {
                        if (spnLeave.getSelectedItemPosition() == 0) {
                            Connection.MessageBox(HIWorkPlaning.this, "ছুটি :ধরন সিলেক্ট করুন।");
                            // dtpDeathDT.requestFocus();
                            return;
                        } else {
                            ItemValue.add("6");
                    ...
                    if (chkNationalProgramAttended.isChecked() == true) {
                        ...
                        if (spnNProgram.getSelectedItemPosition() == 0) {
                            Connection.MessageBox(HIWorkPlaning.this, "জাতীয় প্রোগ্রামে অংশগ্রহনের অবস্থা: সিলেক্ট করুন।");
                            // dtpDeathDT.requestFocus();
                            return;
                        } else {
                            ItemValue.add("10");
                        ...
                        for (String temp : ItemValue) {
...

                            {
                                ...
                                /*else if (temp.equals("3")) {
                                    SQL = "Insert into workPlanDetail (workPlanId,item,workPlanDate,unitNo,village,elcoFrom,elcoTo,fpiOtherMeeting,ipcUN,ipcWord,ipcMouza,ipcVill, ipcPara,ipcBariFrom,ipcBariTo,epiproviderId,epischedulerId,ccWard,ccID,leaveType,natProgramType,providerId,systemEntryDate,modifyDate,otherDec,remarks,upload)Values('" + workplanId1 + "','" + temp + "','" + g.getAreaDate() + "','" + "" + "','" + "" + "','" + "" + "','" + "" + "','" + "" + "','" + "" + "','" + "" + "','" + "" + "','" + "" + "','" + "" + "','" + "" + "','" + "" + "','" + "" + "','" + "" + "','" + (SpnCCWord.getSelectedItemPosition() == 0 ? "" : Global.Left(SpnCCWord.getSelectedItem().toString(), 1)) + "','" + Global.Left(spnccName.getSelectedItem().toString(), 2) + "','" + "" + "','" + "" + "','" + g.getProvCode() + "','" + Global.DateTimeNowYMDHMS() + "','" + "" + "','" + "" + "','" + "','2')";
                                    C.Save(SQL);
                                }*/
                   ...
                   /* if (chkEPIVisit.isChecked() == true && C.Existence("Select workPlanId, providerId, item, workPlanDate from " + TableNameDetail + "  where workPlanId='" + workplanId1 + "' and providerId='" + g.getProvCode() + "' and item = '" + 2 + "' and workPlanDate='" + g.getAreaDate() + "'")) {
                    ...
                    if (chkNationalProgramAttended.isChecked() == true && C.Existence("Select workPlanId, providerId, item, workPlanDate from " + TableNameDetail + "  where workPlanId='" + workplanId1 + "' and providerId='" + g.getProvCode() + "' and item = '" + 10 + "' and workPlanDate='" + g.getAreaDate() + "'")) {
                        ...
                        SQL = "Update workPlanDetail set ";
                        SQL += "natProgramType = '" + (spnLeave.getSelectedItemPosition() == 0 ? "" : Global.Left(spnLeave.getSelectedItem().toString(), 1)) + "',";
                        SQL += "modifyDate = '" + Global.DateTimeNowYMDHMS() + "',";
                        SQL += "upload ='2'";
