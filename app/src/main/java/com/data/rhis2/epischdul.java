 ...
 */
public class epischdul extends Activity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        AlertDialog.Builder adb = new AlertDialog.Builder(epischdul.this);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Connection.MessageBox(epischdul.this, e.getMessage());
            return;
        }
    }
    ...
    private void DataSearch() {
        try {
            ...
            while (!cur.isAfterLast()) {
                ...
                dataAdapter = new SimpleAdapter(epischdul.this, dataList, R.layout.schedulrow, new String[]{"click"},
                        new int[]{R.id.cmdB1});
    ...
    public class DataListAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            // final TextView subblock = (TextView)convertView.findViewById(R.id.subblock);
            ...
            o.get("SchedulerId");
            // subblock.setText(o.get("SubBlockId"));
            epidate.setText(Global.DateConvertDMY(o.get("ScheduleDate")));
            epicenter.setText(o.get("CenterName"));

            final AlertDialog.Builder adb = new AlertDialog.Builder(epischdul.this);
                ...
                public void onClick(View v) {
                    ...
                    adb.setPositiveButton("হাঁ", new AlertDialog.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            //g.setepiSubBlockId(o.get("SubBlockId"));
                            ...
                            startActivity(f1);
                            //Intent f2 = new Intent(getApplicationContext(),EpiList.class);
                            //startActivity(f2);
                        }
                    });
                    adb.show();
