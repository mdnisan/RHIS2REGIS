...
public class PregHis extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try
        {
            ...
            View header = getLayoutInflater().inflate(R.layout.preghisheading, null);
    ...
    private void DataSearch(String Dist, String Upz, String UN, String Mouza, String Vill, String HHNo, String SNo)
    {
        try
        {
            ...
            while(!cur.isAfterLast())
            {
                ...
                dataAdapter = new SimpleAdapter(PregHis.this, dataList, R.layout.preghisrow,new String[] {"edit","del"},
    ...
    public class DataListAdapter extends BaseAdapter
    {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            final AlertDialog.Builder adb = new AlertDialog.Builder(PregHis.this);
