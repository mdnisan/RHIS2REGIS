  ...
  try
    {
        ...
        */
        ...
        spnFNo.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
            if (spnFNo.getSelectedItem().toString().length() == 0) {secFather.setVisibility(View.GONE); return;}
        ...
        spnMNo.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
            if (spnMNo.getSelectedItem().toString().length() == 0) {secMother.setVisibility(View.GONE); return;}
        ...
        rdogrpSex.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            public void onCheckedChanged(RadioGroup arg0, int id) {
                ...
                if(id == R.id.rdoSex1)
                {
                    ...
                    btnSPNo1.setVisibility(View.VISIBLE);
                    spnSPNo.setAdapter( C.getArrayAdapter( "Select '  ' union Select SNo||'-'||NameEng Name from Member Where Dist='"+ g.getDistrict() +"' and Upz='"+ g.getUpazila() +"' and UN='"+ g.getUnion() +"' and Mouza='"+ g.getMouza() +"' and Vill='"+ g.getVillage() +"' and ProvType='"+ g.getProvType() +"' and ProvCode='"+ g.getProvCode() +"' and HHNo='"+ g.getHouseholdNo() +"' and Sex='2' and cast((julianday('now') - julianday(DOB))/365.25 as int)>=10 union Select '77-এই খানার সদস্য না' union Select '88-পরে আপডেট হবে'" ) );
                    spnSPNo1.setAdapter( C.getArrayAdapter( "Select '  ' union Select SNo||'-'||NameEng Name from Member Where Dist='"+ g.getDistrict() +"' and Upz='"+ g.getUpazila() +"' and UN='"+ g.getUnion() +"' and Mouza='"+ g.getMouza() +"' and Vill='"+ g.getVillage() +"' and ProvType='"+ g.getProvType() +"' and ProvCode='"+ g.getProvCode() +"' and HHNo='"+ g.getHouseholdNo() +"' and Sex='2' and cast((julianday('now') - julianday(DOB))/365.25 as int)>=10 union Select '77-এই খানার সদস্য না' union Select '88-পরে আপডেট হবে'" ) );
                    spnSPNo2.setAdapter( C.getArrayAdapter( "Select '  ' union Select SNo||'-'||NameEng Name from Member Where Dist='"+ g.getDistrict() +"' and Upz='"+ g.getUpazila() +"' and UN='"+ g.getUnion() +"' and Mouza='"+ g.getMouza() +"' and Vill='"+ g.getVillage() +"' and ProvType='"+ g.getProvType() +"' and ProvCode='"+ g.getProvCode() +"' and HHNo='"+ g.getHouseholdNo() +"' and Sex='2' and cast((julianday('now') - julianday(DOB))/365.25 as int)>=10 union Select '77-এই খানার সদস্য না' union Select '88-পরে আপডেট হবে'" ) );
                    spnSPNo3.setAdapter( C.getArrayAdapter( "Select '  ' union Select SNo||'-'||NameEng Name from Member Where Dist='"+ g.getDistrict() +"' and Upz='"+ g.getUpazila() +"' and UN='"+ g.getUnion() +"' and Mouza='"+ g.getMouza() +"' and Vill='"+ g.getVillage() +"' and ProvType='"+ g.getProvType() +"' and ProvCode='"+ g.getProvCode() +"' and HHNo='"+ g.getHouseholdNo() +"' and Sex='2' and cast((julianday('now') - julianday(DOB))/365.25 as int)>=10 union Select '77-এই খানার সদস্য না' union Select '88-পরে আপডেট হবে'" ) );
                }
                else if(id == R.id.rdoSex2)
                {
                    VlblSPNo.setText("স্বামীর লাইন নম্বর");
                    btnSPNo1.setVisibility(View.GONE);
                    spnSPNo.setAdapter( C.getArrayAdapter( "Select '  ' union Select SNo||'-'||NameEng Name from Member Where Dist='"+ g.getDistrict() +"' and Upz='"+ g.getUpazila() +"' and UN='"+ g.getUnion() +"' and Mouza='"+ g.getMouza() +"' and Vill='"+ g.getVillage() +"' and ProvType='"+ g.getProvType() +"' and ProvCode='"+ g.getProvCode() +"' and HHNo='"+ g.getHouseholdNo() +"' and Sex='1' and cast((julianday('now') - julianday(DOB))/365.25 as int)>=10 union Select '77-এই খানার সদস্য না' union Select '88-পরে আপডেট হবে'" ) );
                    spnSPNo1.setAdapter( C.getArrayAdapter( "Select '  ' union Select SNo||'-'||NameEng Name from Member Where Dist='"+ g.getDistrict() +"' and Upz='"+ g.getUpazila() +"' and UN='"+ g.getUnion() +"' and Mouza='"+ g.getMouza() +"' and Vill='"+ g.getVillage() +"' and ProvType='"+ g.getProvType() +"' and ProvCode='"+ g.getProvCode() +"' and HHNo='"+ g.getHouseholdNo() +"' and Sex='1' and cast((julianday('now') - julianday(DOB))/365.25 as int)>=10 union Select '77-এই খানার সদস্য না' union Select '88-পরে আপডেট হবে'" ) );
                    spnSPNo2.setAdapter( C.getArrayAdapter( "Select '  ' union Select SNo||'-'||NameEng Name from Member Where Dist='"+ g.getDistrict() +"' and Upz='"+ g.getUpazila() +"' and UN='"+ g.getUnion() +"' and Mouza='"+ g.getMouza() +"' and Vill='"+ g.getVillage() +"' and ProvType='"+ g.getProvType() +"' and ProvCode='"+ g.getProvCode() +"' and HHNo='"+ g.getHouseholdNo() +"' and Sex='1' and cast((julianday('now') - julianday(DOB))/365.25 as int)>=10 union Select '77-এই খানার সদস্য না' union Select '88-পরে আপডেট হবে'" ) );
                    spnSPNo3.setAdapter( C.getArrayAdapter( "Select '  ' union Select SNo||'-'||NameEng Name from Member Where Dist='"+ g.getDistrict() +"' and Upz='"+ g.getUpazila() +"' and UN='"+ g.getUnion() +"' and Mouza='"+ g.getMouza() +"' and Vill='"+ g.getVillage() +"' and ProvType='"+ g.getProvType() +"' and ProvCode='"+ g.getProvCode() +"' and HHNo='"+ g.getHouseholdNo() +"' and Sex='1' and cast((julianday('now') - julianday(DOB))/365.25 as int)>=10 union Select '77-এই খানার সদস্য না' union Select '88-পরে আপডেট হবে'" ) );
                }
                ...
                {
                    btnSPNo1.setVisibility(View.GONE);
                    spnSPNo.setAdapter( C.getArrayAdapter( "Select '  ' union Select SNo||'-'||NameEng Name from Member Where Dist='"+ g.getDistrict() +"' and Upz='"+ g.getUpazila() +"' and UN='"+ g.getUnion() +"' and Mouza='"+ g.getMouza() +"' and Vill='"+ g.getVillage() +"' and ProvType='"+ g.getProvType() +"' and ProvCode='"+ g.getProvCode() +"' and HHNo='"+ g.getHouseholdNo() +"' and Sex in('1','2') and cast((julianday('now') - julianday(DOB))/365.25 as int)>=10 union Select '77-এই খানার সদস্য না' union Select '88-পরে আপডেট হবে'" ) );
                    spnSPNo1.setAdapter( C.getArrayAdapter( "Select '  ' union Select SNo||'-'||NameEng Name from Member Where Dist='"+ g.getDistrict() +"' and Upz='"+ g.getUpazila() +"' and UN='"+ g.getUnion() +"' and Mouza='"+ g.getMouza() +"' and Vill='"+ g.getVillage() +"' and ProvType='"+ g.getProvType() +"' and ProvCode='"+ g.getProvCode() +"' and HHNo='"+ g.getHouseholdNo() +"' and Sex in('1','2') and cast((julianday('now') - julianday(DOB))/365.25 as int)>=10 union Select '77-এই খানার সদস্য না' union Select '88-পরে আপডেট হবে'" ) );
                    spnSPNo2.setAdapter( C.getArrayAdapter( "Select '  ' union Select SNo||'-'||NameEng Name from Member Where Dist='"+ g.getDistrict() +"' and Upz='"+ g.getUpazila() +"' and UN='"+ g.getUnion() +"' and Mouza='"+ g.getMouza() +"' and Vill='"+ g.getVillage() +"' and ProvType='"+ g.getProvType() +"' and ProvCode='"+ g.getProvCode() +"' and HHNo='"+ g.getHouseholdNo() +"' and Sex in('1','2') and cast((julianday('now') - julianday(DOB))/365.25 as int)>=10 union Select '77-এই খানার সদস্য না' union Select '88-পরে আপডেট হবে'" ) );
                    spnSPNo3.setAdapter( C.getArrayAdapter( "Select '  ' union Select SNo||'-'||NameEng Name from Member Where Dist='"+ g.getDistrict() +"' and Upz='"+ g.getUpazila() +"' and UN='"+ g.getUnion() +"' and Mouza='"+ g.getMouza() +"' and Vill='"+ g.getVillage() +"' and ProvType='"+ g.getProvType() +"' and ProvCode='"+ g.getProvCode() +"' and HHNo='"+ g.getHouseholdNo() +"' and Sex in('1','2') and cast((julianday('now') - julianday(DOB))/365.25 as int)>=10 union Select '77-এই খানার সদস্য না' union Select '88-পরে আপডেট হবে'" ) );
                }
                ...
                {
                    spnSPNo.setAdapter( C.getArrayAdapter( "Select '  ' union Select SNo||'-'||NameEng Name from Member Where Dist='"+ g.getDistrict() +"' and Upz='"+ g.getUpazila() +"' and UN='"+ g.getUnion() +"' and Mouza='"+ g.getMouza() +"' and Vill='"+ g.getVillage() +"' and ProvType='"+ g.getProvType() +"' and ProvCode='"+ g.getProvCode() +"' and HHNo='"+ g.getHouseholdNo() +"' and cast((julianday('now') - julianday(DOB))/365.25 as int)>=10 union Select '77-এই খানার সদস্য না' union Select '88-পরে আপডেট হবে'" ) );
                    spnSPNo1.setAdapter( C.getArrayAdapter( "Select '  ' union Select SNo||'-'||NameEng Name from Member Where Dist='"+ g.getDistrict() +"' and Upz='"+ g.getUpazila() +"' and UN='"+ g.getUnion() +"' and Mouza='"+ g.getMouza() +"' and Vill='"+ g.getVillage() +"' and ProvType='"+ g.getProvType() +"' and ProvCode='"+ g.getProvCode() +"' and HHNo='"+ g.getHouseholdNo() +"' and cast((julianday('now') - julianday(DOB))/365.25 as int)>=10 union Select '77-এই খানার সদস্য না' union Select '88-পরে আপডেট হবে'" ) );
                    spnSPNo2.setAdapter( C.getArrayAdapter( "Select '  ' union Select SNo||'-'||NameEng Name from Member Where Dist='"+ g.getDistrict() +"' and Upz='"+ g.getUpazila() +"' and UN='"+ g.getUnion() +"' and Mouza='"+ g.getMouza() +"' and Vill='"+ g.getVillage() +"' and ProvType='"+ g.getProvType() +"' and ProvCode='"+ g.getProvCode() +"' and HHNo='"+ g.getHouseholdNo() +"' and cast((julianday('now') - julianday(DOB))/365.25 as int)>=10 union Select '77-এই খানার সদস্য না' union Select '88-পরে আপডেট হবে'" ) );
                    spnSPNo3.setAdapter( C.getArrayAdapter( "Select '  ' union Select SNo||'-'||NameEng Name from Member Where Dist='"+ g.getDistrict() +"' and Upz='"+ g.getUpazila() +"' and UN='"+ g.getUnion() +"' and Mouza='"+ g.getMouza() +"' and Vill='"+ g.getVillage() +"' and ProvType='"+ g.getProvType() +"' and ProvCode='"+ g.getProvCode() +"' and HHNo='"+ g.getHouseholdNo() +"' and cast((julianday('now') - julianday(DOB))/365.25 as int)>=10 union Select '77-এই খানার সদস্য না' union Select '88-পরে আপডেট হবে'" ) );
                }
        ...
        spnRth.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                if (spnRth.getSelectedItem().toString().length() == 0) {return;}

                String spnData = Global.Left(spnRth.getSelectedItem().toString(), 2);
                String SQL = "";
                SQL = "Select ifnull(FNo,'')||','||ifnull(MNo,'') as SNo";
                ...
                String[] FMNo = Connection.split(C.ReturnSingleValue(SQL).toString(),',');
                ...
                if(spnData.equalsIgnoreCase("02"))
                {
                    ...
                    secSPNo.setVisibility(View.VISIBLE);
                    spnFNo.setAdapter( C.getArrayAdapter( "Select '  ' union Select SNo||'-'||NameEng Name from Member Where Dist='"+ g.getDistrict() +"' and Upz='"+ g.getUpazila() +"' and UN='"+ g.getUnion() +"' and Mouza='"+ g.getMouza() +"' and Vill='"+ g.getVillage() +"' and ProvType='"+ g.getProvType() +"' and ProvCode='"+ g.getProvCode() +"' and HHNo='"+ g.getHouseholdNo() +"' and Sex='1' and Rth not in('01') union Select '55-মারা গিয়েছে' union Select '77-এই খানার সদস্য না' union Select '88-পরে আপডেট হবে'" ) );
                    spnMNo.setAdapter( C.getArrayAdapter( "Select '  ' union Select SNo||'-'||NameEng Name from Member Where Dist='"+ g.getDistrict() +"' and Upz='"+ g.getUpazila() +"' and UN='"+ g.getUnion() +"' and Mouza='"+ g.getMouza() +"' and Vill='"+ g.getVillage() +"' and ProvType='"+ g.getProvType() +"' and ProvCode='"+ g.getProvCode() +"' and HHNo='"+ g.getHouseholdNo() +"' and Sex='2' and Rth not in('01') union Select '55-মারা গিয়েছে' union Select '77-এই খানার সদস্য না' union Select '88-পরে আপডেট হবে'" ) );
                }
                else if(spnData.equalsIgnoreCase("03") &  HeadSex().equals("1"))
                {
                    spnFNo.setAdapter( C.getArrayAdapter( "Select '  ' union Select SNo||'-'||NameEng Name from Member Where Dist='"+ g.getDistrict() +"' and Upz='"+ g.getUpazila() +"' and UN='"+ g.getUnion() +"' and Mouza='"+ g.getMouza() +"' and Vill='"+ g.getVillage() +"' and ProvType='"+ g.getProvType() +"' and ProvCode='"+ g.getProvCode() +"' and HHNo='"+ g.getHouseholdNo() +"' and Sex='1' and Rth in('01') union Select '55-মারা গিয়েছে' union Select '77-এই খানার সদস্য না'" ) );
                    spnMNo.setAdapter( C.getArrayAdapter( "Select '  ' union Select SNo||'-'||NameEng Name from Member Where Dist='"+ g.getDistrict() +"' and Upz='"+ g.getUpazila() +"' and UN='"+ g.getUnion() +"' and Mouza='"+ g.getMouza() +"' and Vill='"+ g.getVillage() +"' and ProvType='"+ g.getProvType() +"' and ProvCode='"+ g.getProvCode() +"' and HHNo='"+ g.getHouseholdNo() +"' and Sex='2' and Rth in('02') union Select '55-মারা গিয়েছে' union Select '77-এই খানার সদস্য না' union Select '88-পরে আপডেট হবে'" ) );
                }
                else if(spnData.equalsIgnoreCase("03") &  HeadSex().equals("2"))
                {
                    spnFNo.setAdapter( C.getArrayAdapter( "Select '  ' union Select SNo||'-'||NameEng Name from Member Where Dist='"+ g.getDistrict() +"' and Upz='"+ g.getUpazila() +"' and UN='"+ g.getUnion() +"' and Mouza='"+ g.getMouza() +"' and Vill='"+ g.getVillage() +"' and ProvType='"+ g.getProvType() +"' and ProvCode='"+ g.getProvCode() +"' and HHNo='"+ g.getHouseholdNo() +"' and Sex='1' and Rth in('02') union Select '55-মারা গিয়েছে' union Select '77-এই খানার সদস্য না' union Select '88-পরে আপডেট হবে'" ) );
                    spnMNo.setAdapter( C.getArrayAdapter( "Select '  ' union Select SNo||'-'||NameEng Name from Member Where Dist='"+ g.getDistrict() +"' and Upz='"+ g.getUpazila() +"' and UN='"+ g.getUnion() +"' and Mouza='"+ g.getMouza() +"' and Vill='"+ g.getVillage() +"' and ProvType='"+ g.getProvType() +"' and ProvCode='"+ g.getProvCode() +"' and HHNo='"+ g.getHouseholdNo() +"' and Sex='2' and Rth in('01') union Select '55-মারা গিয়েছে' union Select '77-এই খানার সদস্য না'" ) );
                }
                else
                {
                    spnFNo.setAdapter( C.getArrayAdapter( "Select '  ' union Select SNo||'-'||NameEng Name from Member Where Dist='"+ g.getDistrict() +"' and Upz='"+ g.getUpazila() +"' and UN='"+ g.getUnion() +"' and Mouza='"+ g.getMouza() +"' and Vill='"+ g.getVillage() +"' and ProvType='"+ g.getProvType() +"' and ProvCode='"+ g.getProvCode() +"' and HHNo='"+ g.getHouseholdNo() +"' and Sex='1' union Select '55-মারা গিয়েছে' union Select '77-এই খানার সদস্য না' union Select '88-পরে আপডেট হবে'" ) );
                    spnMNo.setAdapter( C.getArrayAdapter( "Select '  ' union Select SNo||'-'||NameEng Name from Member Where Dist='"+ g.getDistrict() +"' and Upz='"+ g.getUpazila() +"' and UN='"+ g.getUnion() +"' and Mouza='"+ g.getMouza() +"' and Vill='"+ g.getVillage() +"' and ProvType='"+ g.getProvType() +"' and ProvCode='"+ g.getProvCode() +"' and HHNo='"+ g.getHouseholdNo() +"' and Sex='2' union Select '55-মারা গিয়েছে' union Select '77-এই খানার সদস্য না' union Select '88-পরে আপডেট হবে'" ) );
                }
                if(FMNo.length==2) {
                    spnFNo.setSelection(Global.SpinnerItemPosition(spnFNo, 2, FMNo[0]));
                    spnMNo.setSelection(Global.SpinnerItemPosition(spnMNo, 2, FMNo[1]));
                }

                if(spnData.equalsIgnoreCase("03") & HeadSex().equals("1"))
                {
                    spnFNo.setSelection(Global.SpinnerItemPosition(spnFNo,2,HeadSerialNo()));
                }
                else if(spnData.equalsIgnoreCase("03") & HeadSex().equals("2"))
                {
                    spnMNo.setSelection(Global.SpinnerItemPosition(spnMNo,2,HeadSerialNo()));
                }
        ...
        public void onClick(View v) { VariableID = "btnDOB"; showDialog(DATE_DIALOG); }});
    ...
    {
        String HeadSl = C.ReturnSingleValue("Select SNo from Member where dist='"+ g.getDistrict() +"' and upz='"+ g.getUpazila() +"' and un='"+ g.getUnion() +"' and Mouza='"+ g.getMouza() +"' and vill='"+ g.getVillage() +"' and ProvType='"+ g.getProvType() +"' and ProvCode='"+ g.getProvCode() +"' and HHNo='"+ g.getHouseholdNo() +"' and Rth='01' and (length(ExType)=0 or ExType is null)");
        return HeadSl;
    }

    private String HeadSex()
    {
        String HSex = C.ReturnSingleValue("Select Sex from Member where dist='"+ g.getDistrict() +"' and upz='"+ g.getUpazila() +"' and un='"+ g.getUnion() +"' and Mouza='"+ g.getMouza() +"' and vill='"+ g.getVillage() +"' and ProvType='"+ g.getProvType() +"' and ProvCode='"+ g.getProvCode() +"' and HHNo='"+ g.getHouseholdNo() +"' and Rth='01' and (length(ExType)=0 or ExType is null)");
        return HSex;
    }
...
private String SerialNumber()
{
    ...
    private String HHHead(String SerialNo)
    {
        ...
        SQL += " where";
        SQL += " dist='"+ g.getDistrict() +"' and upz='"+ g.getUpazila() +"' and un='"+ g.getUnion() +"' and Mouza='"+ g.getMouza() +"' and vill='"+ g.getVillage() +"' and ProvType='"+ g.getProvType() +"' and ProvCode='"+ g.getProvCode() +"' and HHNo='"+ g.getHouseholdNo() +"' and Rth='01' and SNo != '"+ SerialNo +"'";
    ...
    private String HHHeadOppositeSex()
    {
        ...
        SQL += " where";
        SQL += " dist='"+ g.getDistrict() +"' and upz='"+ g.getUpazila() +"' and un='"+ g.getUnion() +"' and Mouza='"+ g.getMouza() +"' and vill='"+ g.getVillage() +"' and ProvType='"+ g.getProvType() +"' and ProvCode='"+ g.getProvCode() +"' and HHNo='"+ g.getHouseholdNo() +"' and Rth='01'";
 ...
 private void ChkChildAgeWithFatherAge()
{
        ...
        SQL += " where";
        SQL += " dist='"+ g.getDistrict() +"' and upz='"+ g.getUpazila() +"' and un='"+ g.getUnion() +"' and Mouza='"+ g.getMouza() +"' and vill='"+ g.getVillage() +"' and ProvType='"+ g.getProvType() +"' and ProvCode='"+ g.getProvCode() +"' and HHNo='"+ g.getHouseholdNo() +"' and SNo='"+ Global.Left(spnFNo.getSelectedItem().toString(),2) +"' and sex='1'";
    ...
    private void ChkChildAgeWithMotherAge()
    {
        ...
        SQL = "Select DOB  from Member";
        SQL += " where";
        SQL += " dist='"+ g.getDistrict() +"' and upz='"+ g.getUpazila() +"' and un='"+ g.getUnion() +"' and Mouza='"+ g.getMouza() +"' and vill='"+ g.getVillage() +"' and ProvType='"+ g.getProvType() +"' and ProvCode='"+ g.getProvCode() +"' and HHNo='"+ g.getHouseholdNo() +"' and SNo='"+ Global.Left(spnFNo.getSelectedItem().toString(),2) +"' and sex='2'";//txtSNo.getText().toString()
  ...
  try
    {
        ...
        */
        ...
        if(!C.Existence("Select Dist,Upz,UN,Mouza,Vill,HHNo,SNo from " + TableName + "  Where Dist='"+ g.getDistrict() +"' and Upz='"+ g.getUpazila() +"' and UN='"+ g.getUnion() +"' and Mouza='"+ g.getMouza() +"' and Vill='"+ g.getVillage() +"' and ProvType='"+ g.getProvType() +"' and ProvCode='"+ g.getProvCode() +"' and HHNo='"+ g.getHouseholdNo() +"' and SNo='"+ txtSNo.getText().toString() +"'"))
        {
        ...
        {
            SQL+="DOB = '"+ Global.addDaysYMD(Global.DateNowDMY(), -Integer.valueOf(txtAge.getText().toString())*365) +"',";
        ...
        if(Rth.equals("02"))
        {
            String SP = C.ReturnSingleValue("select (case when spno1='88' or spno1='"+ txtSNo.getText().toString() +"' or length(spno1)=0 then 'spno1' when spno2='88' or spno2='"+ txtSNo.getText().toString() +"' or length(spno2)=0 then 'spno2' when spno3='88' or spno3='"+ txtSNo.getText().toString() +"' or length(spno3)=0 then 'spno3' when spno4='88' or spno1='"+ txtSNo.getText().toString() +"' or length(spno4)=0 then 'spno4' end)SP from member where Dist='"+ g.getDistrict() +"' and Upz='"+ g.getUpazila() +"' and UN='"+ g.getUnion() +"' and Mouza='"+ g.getMouza() +"' and Vill='"+ g.getVillage() +"' and ProvType='"+ g.getProvType() +"' and ProvCode='"+ g.getProvCode() +"' and HHNo='"+ g.getHouseholdNo() +"' and Rth='01' and (length(ExType)=0 or ExType is null)");
            C.Save("Update Member Set "+ SP +"='"+ txtSNo.getText() +"' where Dist='"+ g.getDistrict() +"' and Upz='"+ g.getUpazila() +"' and UN='"+ g.getUnion() +"' and Mouza='"+ g.getMouza() +"' and Vill='"+ g.getVillage() +"' and ProvType='"+ g.getProvType() +"' and ProvCode='"+ g.getProvCode() +"' and HHNo='"+ g.getHouseholdNo() +"' and Rth='01' and (length(ExType)=0 or ExType is null)");
        }
        ...
        {
            C.Save("Update Member Set MNo='"+ txtSNo.getText() +"' where Dist='"+ g.getDistrict() +"' and Upz='"+ g.getUpazila() +"' and UN='"+ g.getUnion() +"' and Mouza='"+ g.getMouza() +"' and Vill='"+ g.getVillage() +"' and ProvType='"+ g.getProvType() +"' and ProvCode='"+ g.getProvCode() +"' and HHNo='"+ g.getHouseholdNo() +"' and Rth='01' and (length(ExType)=0 or ExType is null)");
        }
      ...
      try
       {    
          ...
          while(!cur.isAfterLast())
          {
            ...
            txtNameEng.setText(cur.getString(cur.getColumnIndex("NameEng")));
            txtNameBang.setText(cur.getString(cur.getColumnIndex("NameBang")));
...
*/
            txtBRID.setText(cur.getString(cur.getColumnIndex("BRID")));
            spnBRIDStatus.setSelection(Global.SpinnerItemPosition(spnBRIDStatus, 1 ,cur.getString(cur.getColumnIndex("BRIDStatus"))));
            txtMobileNo1.setText(cur.getString(cur.getColumnIndex("MobileNo1")));
            txtMobileNo2.setText(cur.getString(cur.getColumnIndex("MobileNo2")));
            ...
            spnFNo.setSelection(Global.SpinnerItemPosition(spnFNo, 2 ,cur.getString(cur.getColumnIndex("FNo"))));
            txtFather.setText(cur.getString(cur.getColumnIndex("Father")));
            ...
            txtMother.setText(cur.getString(cur.getColumnIndex("Mother")));
