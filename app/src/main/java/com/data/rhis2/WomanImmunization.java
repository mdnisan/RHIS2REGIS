...
public class WomanImmunization extends Activity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        AlertDialog.Builder adb = new AlertDialog.Builder(WomanImmunization.this);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            setContentView(R.layout.womanimmunization);
            ...
            Connection.MessageBox(WomanImmunization.this, ex.getMessage());
            return;
        }
    }
        ...
        try {
            ...
            while (!cur1.isAfterLast()) {
                ...
                if (cur1.getString(cur1.getColumnIndex("MobileNo1")).length() > 0)
                    ((TextView) findViewById(R.id.txtMobile)).setText(cur1.getString(cur1.getColumnIndex("MobileNo1")));
                else if (cur1.getString(cur1.getColumnIndex("MobileNo2")).length() > 0)
                    ((TextView) findViewById(R.id.txtMobile)).setText(cur1.getString(cur1.getColumnIndex("MobileNo2")));
            ...
            Connection.MessageBox(WomanImmunization.this, e.getMessage());
        }
    }
    ...
    private void RefreshGrid(Boolean heading) {
        ...
        String sqlString = "select A.imuCode AS imuCode, A.imuName AS imuName, A.numOfDose AS numOfDose, B.imuDate AS imuDate" +
                " FROM immunization A " +
                " LEFT JOIN womanImmunization B ON A.imuCode=B.imuCode and B.HealthId = '" + g.getHealthID() + "' WHERE A.forWoman='1'";
        ...
        while (!cur.isAfterLast()) {
            ...
            switch (imuCode) {
                ...
                case 17:
                    map.put("datetobegiven", Global.addDays(((TextView) findViewById(R.id.txtDOB)).getText().toString(), 5475));
            ...
            mAdapter = new SimpleAdapter(WomanImmunization.this, mylist, R.layout.childimulistrow, new String[]{"imuCode"},
    ...
    private void DiaplayPopup(String healthId, final String imuCode, String imuName, String dose, String datetobegiven, String dategiven) {
        popupView = new Dialog(WomanImmunization.this);
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    if (String.valueOf(((TextView) popupView.findViewById(R.id.popupDate)).getText().toString()).length() <= 0) {
                        Connection.MessageBox(WomanImmunization.this, "তারিখ লিখুন");
                        return;
                    }

                    if (imuCode != null) {
                        sql = "SELECT imuCode FROM womanImmunization WHERE imuCode='" + imuCode + "' AND HealthId = '" + g.getHealthID() + "'";
                        if (!C.Existence(sql)) {
                            sql = "INSERT INTO womanImmunization (healthId, providerId, slNo, regDate, houseNo, imuCode, imuDate, systemEntryDate)";
                            sql = sql + "VALUES ('" + txtHealthId.getText().toString() + "', '" + g.getProvCode() + "','" + ((TextView) findViewById(R.id.txtSNo)).getText().toString() + "','" +
                                    ((TextView) findViewById(R.id.txtRegDate)).getText().toString() + "','" + ((TextView) findViewById(R.id.txtHouse)).getText().toString() + "','" +
                            ...
                            sql = "UPDATE womanImmunization SET imuDate = '" + String.valueOf(((TextView) popupView.findViewById(R.id.popupDate)).getText().toString()) +
        ...
        public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
            ...
            try {
                ...
                if (date2.after(date1)) {
                    ...
                    if (VariableID.equals("btnRegDT")) {
                        Connection.MessageBox(WomanImmunization.this, "তারিখ আজকের তারিখের সমান অথবা কম হতে হবে।");
                        return;
                    }
