...
public class AHIWorkPlaningViewHINotAproved extends Activity {
    Calendar calendar;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        AlertDialog.Builder adb = new AlertDialog.Builder(AHIWorkPlaningViewHINotAproved.this);
   ...
   // TextView VlblfpaVill;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            setContentView(R.layout.ahiworkplaningviewnotaproved);
            ...
            lblHS10.setText("সহকারী স্বাস্থ্য পরিদর্শকের  মাসিক অগ্রিম কর্মসূচী অননুমোদিত");
            ...
            spnFPIPMonth.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                    ...
                    if (val.length() >= 0) {
                        ...
                        txtFpiWarea.setText(C.ReturnSingleValue("select cast(unionid as varchar(2))||','||unionname from Unions where zillaid='" + g.getDistrict() + "' and upazilaid='" + g.getUpazila() + "' and unionid in(" + union + ")"));
          ...
          //  DisplaySearch(true);
            ...
            cmdSync.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    ...
                    //*******************************************************************************
                    boolean netwoekAvailable = false;
                    if (Connection.haveNetworkConnection(AHIWorkPlaningViewHINotAproved.this)) {
                        netwoekAvailable = true;
                        //  UploadFWA();
                        final ProgressDialog progDailog = ProgressDialog.show(
                                AHIWorkPlaningViewHINotAproved.this, "", "অপেক্ষা করুন ...", true);
                        new Thread() {
                            public void run() {
                        ...
                        Connection.MessageBox(AHIWorkPlaningViewHINotAproved.this, "Internet connection is not available.");
                        // return true;
                    }
 ...
 */
            ...
            while (!cur.isAfterLast()) {
                ...
                dataAdapter = new SimpleAdapter(AHIWorkPlaningViewHINotAproved.this, dataList, R.layout.fpaworkplanrowview, new String[]{"edit"},
                        new int[]{R.id.cmdB1});

                list.setAdapter(new AHIWorkPlaningViewHINotAproved.DataListAdapter(this));
