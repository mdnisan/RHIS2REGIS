...
/**
 * Created by Nisan on 1/10/2016.
 */
public class EpiNonRegistrationWomen extends Activity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        AlertDialog.Builder adb = new AlertDialog.Builder(EpiNonRegistrationWomen.this);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            setContentView(R.layout.epinonregistrationwomen);
            ...
            Connection.MessageBox(EpiNonRegistrationWomen.this, e.getMessage());
            return;
        }
    }
    ...
    private void DataSave() {
        try {
            ...
            if (txtcName.getText().toString().length() == 0 & seccName.isShown()) {
                Connection.MessageBox(EpiNonRegistrationWomen.this, "Required field:Name.");
                txtcName.requestFocus();
                return;
            } else if (txtage.getText().toString().length() == 0 & secage.isShown()) {
                Connection.MessageBox(EpiNonRegistrationWomen.this, "Required field:Age.");
                txtage.requestFocus();
                return;
            } else if (!rdosex1.isChecked() & !rdosex2.isChecked() & secsex.isShown()) {
                Connection.MessageBox(EpiNonRegistrationWomen.this, "Select anyone options from sex.");
                rdosex1.requestFocus();
                return;
            } else if (txtfName.getText().toString().length() == 0 & secfName.isShown()) {
                Connection.MessageBox(EpiNonRegistrationWomen.this, "Required field:Father Name.");
                txtfName.requestFocus();
                return;
            } else if (txtmName.getText().toString().length() == 0 & secmName.isShown()) {
                Connection.MessageBox(EpiNonRegistrationWomen.this, "Required field:Mother Name.");
                txtmName.requestFocus();
                return;
            } else if (spnDiv.getSelectedItemPosition() == 0 & secDiv.isShown()) {
                Connection.MessageBox(EpiNonRegistrationWomen.this, "Required field:Division.");
                // txtDistrict.requestFocus();
                return;
            } else if (spnDistrict.getSelectedItemPosition() == 0 & secDistrict.isShown()) {
                Connection.MessageBox(EpiNonRegistrationWomen.this, "Required field:District.");
                // txtDistrict.requestFocus();
                return;
                ...
                Connection.MessageBox(EpiNonRegistrationWomen.this, "Required field:Union.");
                //txtUnion.requestFocus();
                return;
            } else if (spnVillage.getSelectedItemPosition() == 0 & secVillage.isShown()) {
                Connection.MessageBox(EpiNonRegistrationWomen.this, "Required field:Village.");
                //txtVillage.requestFocus();
                return;
            } else if (spnMouza.getSelectedItemPosition() == 0 & secMouza.isShown()) {
                Connection.MessageBox(EpiNonRegistrationWomen.this, "Required field:Mouza.");
                // txtMouza.requestFocus();
                return;
            } else if (txtBari.getText().toString().length() == 0 & secBari.isShown()) {
                Connection.MessageBox(EpiNonRegistrationWomen.this, "Required field:Bari.");
                txtBari.requestFocus();
                return;
            } else if (txtmobileNo.getText().toString().length() == 0 & secmobileNo.isShown()) {
                Connection.MessageBox(EpiNonRegistrationWomen.this, "Required field:Mobile No.");
            ...
            // SQL+=" where Cluster='"+ cluster +"' and Block='"+ block +"' and HH='"+ hh +"' and StudyID='"+ txtStudyId.getText() +"'and Visit='"+ txtVisitNo.getText()+"'";
            C.Save(SQL);
            Connection.MessageBox(EpiNonRegistrationWomen.this, "তথ্য সফলভাবে সংরক্ষণ হয়েছে।");
            finish();
            //Connection.MessageBox(EpiNonRegistration.this, "তথ্য সফলভাবে সংরক্ষণ হয়েছে।");
            //finish();
