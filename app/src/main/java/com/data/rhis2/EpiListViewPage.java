...
public class EpiListViewPage extends Activity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        AlertDialog.Builder adb = new AlertDialog.Builder(EpiListViewPage.this);
            ...
            case R.id.menuClose:
                ...
                adb.setPositiveButton("হাঁ", new AlertDialog.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        finish();
                        /*Intent f1 = new Intent(getApplicationContext(),EpiListViewPage.class);
                        startActivity(f1);*/
                    }
                });
                adb.show();
...
/*    TextView txtHHNo;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            setContentView(R.layout.epilistviewpage);
            ...
            Connection.MessageBox(EpiListViewPage.this, ex.getMessage());
            return;
        }
    }
            ...
            cmdSearch.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    ...
                    if (txtSearch.length() == 0) {
                        Connection.MessageBox(EpiListViewPage.this, "Required field:Search..");
                        txtSearch.requestFocus();
                        return;
                    }
                    DataRetrieve("", list, "active", "", txtSearch.getText().toString());
...
// :EPIBlock Search
            ...
            if (txtSearch.length() == 0) {
                ...
                SQLStr = "Select distinct epimaster.healthId As epiHealthId,epimaster.regNo AS regNo, (case when epimaster.regNo is not null then '2' else '1' end) as regC,strftime('%d/%m/%Y', date(epimaster.regDate)) AS regDate,epimaster.houseNo AS houseNo, epiMaster.brCertificateNo AS brCertificateNo," +
                        ...
                        " LEFT JOIN epiMaster epimaster ON epimaster.healthId = Member.healthid" +
                        " WHERE Cast(((julianday(date('now'))-julianday(Member.DOB))/30.4) as int) <=18 and h.EPIBlock<>'0' and member.HealthID='" + healthId + "'";
            ...
            while (!cur1.isAfterLast()) {
                ...
                mylist.add(map);
                mSchedule = new SimpleAdapter(EpiListViewPage.this, mylist, R.layout.epilistrow, new String[]{"HealthID"},
            ...
            Connection.MessageBox(EpiListViewPage.this, e.getMessage());
        }
    }
            ...
            try {
               ...
               /* memtab.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        ...
                        {
                            Connection.MessageBox(EpiListViewPage.this, "ই পি আই কেন্দ্র নাম খালি হতে পারে না");
        ...
        public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
            ...
            try {
                ...
                if (date2.after(date1))
                {
                    ...
                    {
                        Connection.MessageBox(EpiListViewPage.this, "তারিখ আজকের তারিখের সমান অথবা কম হতে হবে।");
                        return;
                    }
